...
<body>
	...
	<div class="container">
		...
		<form action="location-historical-search-results">
			<label>City</label><input type="text" name="city"> <label>State</label><input
				type="text" name="state"><input type="Submit"
				class="btn btn-dark">
